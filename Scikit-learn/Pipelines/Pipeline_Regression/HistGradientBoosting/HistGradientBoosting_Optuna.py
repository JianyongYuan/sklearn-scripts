...
pipe_params = {}
pipe_params['hgbr__max_iter'] = optuna.distributions.IntUniformDistribution(50,400,5)
pipe_params['hgbr__max_leaf_nodes'] = optuna.distributions.IntUniformDistribution(30,150,5)
pipe_params['hgbr__max_depth'] = optuna.distributions.IntUniformDistribution(2,20,1)
pipe_params['hgbr__min_samples_leaf'] = optuna.distributions.IntUniformDistribution(1,30,1)
pipe_params['hgbr__l2_regularization'] = optuna.distributions.LogUniformDistribution(1e-6,1e1)
pipe_params['hgbr__learning_rate'] = optuna.distributions.LogUniformDistribution(1e-4,1e-1)
