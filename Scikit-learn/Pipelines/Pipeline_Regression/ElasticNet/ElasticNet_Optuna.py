...
pipe_params['en__alpha'] = optuna.distributions.LogUniformDistribution(1e-3,1e4)
pipe_params['en__selection'] = optuna.distributions.CategoricalDistribution(['cyclic', 'random'])
if pipe_params['en__selection'] == 'random':
    pipe_params['en__random_state'] = optuna.distributions.IntUniformDistribution(0,10000)
