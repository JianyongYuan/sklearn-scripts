...
pipe_params = {}  
pipe_params['rfr__n_estimators'] = optuna.distributions.IntUniformDistribution(30,300,5)
pipe_params['rfr__max_features'] = optuna.distributions.CategoricalDistribution([0.3,0.5,0.8,1.0])
pipe_params['rfr__max_depth'] = optuna.distributions.IntUniformDistribution(5,25,1)
pipe_params['rfr__min_samples_split'] = optuna.distributions.IntUniformDistribution(2,20,1)
pipe_params['rfr__min_samples_leaf'] = optuna.distributions.IntUniformDistribution(1,20,1)
pipe_params['rfr__bootstrap'] = optuna.distributions.CategoricalDistribution([True, False])
#pipe_params['rfr__ccp_alpha'] = optuna.distributions.UniformDistribution(0,10)
