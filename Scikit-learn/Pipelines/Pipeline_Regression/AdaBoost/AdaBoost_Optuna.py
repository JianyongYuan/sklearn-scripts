...
# pipe_params['abr__base_estimator'] = optuna.distributions.CategoricalDistribution(
   # [DecisionTreeRegressor(max_depth=6), 
    ...
    # )
pipe_params['abr__estimator'] = optuna.distributions.CategoricalDistribution(
    [DecisionTreeRegressor(max_depth=i) for i in range(3,15)]
    )
pipe_params['abr__loss'] = optuna.distributions.CategoricalDistribution(['linear', 'square', 'exponential'])
pipe_params['abr__n_estimators'] = optuna.distributions.IntUniformDistribution(40,300,5)
pipe_params['abr__learning_rate'] = optuna.distributions.LogUniformDistribution(1e-2,1e0)
