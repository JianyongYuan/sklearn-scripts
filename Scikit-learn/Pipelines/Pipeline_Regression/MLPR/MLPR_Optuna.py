...
pipe_params['mlpr__alpha'] = optuna.distributions.LogUniformDistribution(1e-3,1e3)
pipe_params['mlpr__hidden_layer_sizes'] = optuna.distributions.CategoricalDistribution(tuple_combinations)
pipe_params['mlpr__learning_rate_init'] = optuna.distributions.LogUniformDistribution(1e-6,1e-1)
