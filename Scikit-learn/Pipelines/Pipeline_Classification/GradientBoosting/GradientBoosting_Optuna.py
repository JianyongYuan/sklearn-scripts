...
model_name = "GradientBoostingClassifier"  #  "GradientBoostingRegressor" or "GradientBoostingClassifier"
...
pipe_params = {}
# pipe_params['gbc__loss'] = optuna.distributions.CategoricalDistribution(['huber'])
pipe_params['gbc__learning_rate'] = optuna.distributions.LogUniformDistribution(1e-3,1e0)
pipe_params['gbc__n_estimators'] = optuna.distributions.IntUniformDistribution(50,400,5)
pipe_params['gbc__max_features'] = optuna.distributions.CategoricalDistribution([0.3,0.5,0.8,1.0])
pipe_params['gbc__max_depth'] = optuna.distributions.IntUniformDistribution(2,20,1)
pipe_params['gbc__min_samples_split'] = optuna.distributions.IntUniformDistribution(2,5,1)
pipe_params['gbc__min_samples_leaf'] = optuna.distributions.IntUniformDistribution(1,5,1)
#pipe_params['gbc__ccp_alpha'] = optuna.distributions.UniformDistribution(0,10)
# if pipe_params['gbc__loss'] == 'huber':
#     pipe_params['gbc__alpha'] = optuna.distributions.UniformDistribution(0,1)
