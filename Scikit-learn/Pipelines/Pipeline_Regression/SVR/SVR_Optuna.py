...
pipe_params['svr__C'] = optuna.distributions.LogUniformDistribution(1e-2, 1e3)
pipe_params['svr__gamma'] = optuna.distributions.LogUniformDistribution(1e-2, 1e3)
pipe_params['svr__epsilon'] = optuna.distributions.LogUniformDistribution(1e-2, 1e3)
if pipe_params["svr__kernel"] == "poly": 
    pipe_params["svr__degree"] = optuna.distributions.IntUniformDistribution(2, 3)
