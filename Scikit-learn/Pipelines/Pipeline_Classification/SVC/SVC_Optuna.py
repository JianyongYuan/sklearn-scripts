...
model_name = "SVC"  #  "SVR" or "SVC"
model_params = {'max_iter':10000, 'class_weight':'balanced', 'random_state':0}
...
pipe_params = {} 
pipe_params['svc__kernel'] = optuna.distributions.CategoricalDistribution(choices=['rbf','linear','poly','sigmoid'])
pipe_params['svc__C'] = optuna.distributions.LogUniformDistribution(1e-2, 1e3)
pipe_params['svc__gamma'] = optuna.distributions.LogUniformDistribution(1e-2, 1e3)
if pipe_params["svc__kernel"] == "poly": 
    pipe_params["svc__degree"] = optuna.distributions.IntUniformDistribution(2, 3)
