...
pipe_params['gbr__learning_rate'] = optuna.distributions.LogUniformDistribution(1e-4,1e0)
pipe_params['gbr__n_estimators'] = optuna.distributions.IntUniformDistribution(50,400,5)
pipe_params['gbr__max_features'] = optuna.distributions.CategoricalDistribution([0.3,0.5,0.8,1.0])
pipe_params['gbr__max_depth'] = optuna.distributions.IntUniformDistribution(2,20,1)
...
#pipe_params['gbr__ccp_alpha'] = optuna.distributions.UniformDistribution(0,10)
