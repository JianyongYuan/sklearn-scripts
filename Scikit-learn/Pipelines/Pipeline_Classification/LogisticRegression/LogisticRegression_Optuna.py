...
model_name = "LogisticRegression"  # "LinearRegression", "Ridge", "Lasso", "ElasticNet", and "LogisticRegression"
model_params = {'max_iter':20000, 'class_weight':'balanced'}
...
pipe_params = {}
pipe_params['lr__solver'] = optuna.distributions.CategoricalDistribution(['saga','lbfgs'])
pipe_params['lr__C'] = optuna.distributions.LogUniformDistribution(1e-3,1e3)
if pipe_params['lr__solver'] == 'saga':
    pipe_params['lr__penalty'] = 'elasticnet'
    pipe_params['lr__l1_ratio'] = optuna.distributions.UniformDistribution(0,1)
elif pipe_params['lr__solver'] == 'lbfgs':
    pipe_params['lr__penalty'] = 'l1'
