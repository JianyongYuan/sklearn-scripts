...
model_name = "AdaBoostClassifier"  #  "AdaBoostRegressor" or "AdaBoostClassifier"
...
pipe_params = {}
# pipe_params['abc__base_estimator'] = optuna.distributions.CategoricalDistribution(
   # [DecisionTreeClassifier(class_weight='balanced', max_depth=3),
    ...
    # )
pipe_params['abc__estimator'] = optuna.distributions.CategoricalDistribution(
    [DecisionTreeClassifier(class_weight='balanced', max_depth=i) for i in range(3,15)]
    )
pipe_params['abc__n_estimators'] = optuna.distributions.IntUniformDistribution(40,400,5)
pipe_params['abc__learning_rate'] = optuna.distributions.LogUniformDistribution(1e-4,1e0)
